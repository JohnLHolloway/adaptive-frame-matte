...
document.addEventListener('submit', async e=>{
 ...
 try {
  switch(f.dataset.form) {
   ...
   case 'schedule': data.sun_offset_minutes=Number(data.sun_offset_minutes); for(const k of ['latitude','longitude']) {if(data[k]==='') delete data[k]; else data[k]=Number(data[k]);} await api('/api/settings',data); await refresh(); break;
